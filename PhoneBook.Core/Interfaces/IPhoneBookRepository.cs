...
namespace PhoneBook.Core.Interfaces
{
    public interface IPhoneBookRepository
    {
        ...
        /// <returns></returns>
        Task<GetPhoneBook> GetUser(int id, int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<IEnumerable<GetPhoneBook>> GetUsersOrdered(bool firstnameOrder, bool ascOrder, int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<GetPhoneBook> PostUser(PhoneBookVM vm, int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<GetPhoneBook> PutUser(PhoneBookVM vm, int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<bool> DeleteUser(int id, int fileType);
        /// <summary>
        /// Gets all phone types from specified filetype
        /// </summary>
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<IEnumerable<PhoneTypesVM>> GetPhoneTypes(int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<GetPhoneBook> AddPhoneNumber(PhoneBookVM vm, int fileType);
        /// <summary>
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        Task<bool> AddPhoneTypesVM(PostPhoneTypesVM vm, int fileType);
    }
}
